...
// The theorem specifies that the relation between the sides of a right-angled triangle is a^2 + b^2 = c^2.
// You can use prompt() to get the value for a and b.
// Write code to get the value from the user for a and b. 
...
let a = prompt("Qual o valor do lado A?");
let b = prompt("Qual o valor do lado B?");
