...
// 2. Using a for loop, create a list of 10 objects, each of which is a numbered lesson (e.g. Lesson 1, Lesson 2, Lesson 3….) with an alternating true/false status for every other item to indicate whether the class will be running this year.
// For example: 
...
for(let i = 0; i < 10; i++) {
    stat = (i % 2) ? false : true
    let lesson = {name: `Lesson ${i + 1}`, status: stat}
    myWork.push(lesson);
};
