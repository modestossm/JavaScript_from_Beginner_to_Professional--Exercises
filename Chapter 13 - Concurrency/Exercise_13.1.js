// This exercise will demonstrate how to use a callback function, creating a way to pass a value from one function to another by invoking a callback function. 
...
function second(param, cb) {
    const fullName = param.split(" ");
    cb(fullName);
}

second("Laurence Svekis", greet);